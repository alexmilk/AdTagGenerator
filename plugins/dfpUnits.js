...
const dfpSlots = {
    ...
    singleRedirectBroken: {
        "slotType": "Single Redirect Broken (Fallback)",
    ...
    singleNonlinearInline: {
        "slotType": "Single Non-linear Inline",
    ...
    vMAPPostRollBumper: {
        "slotType": "VMAP Post-roll + Bumper",
    ...
    vMAPPreMidPostSingleAds: {
        "slotType": "VMAP Pre-, Mid-, and Post-rolls, Single Ads",
